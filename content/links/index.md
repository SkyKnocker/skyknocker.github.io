...
date: "2026-01-31"
description: "A curated list of tools, documentation, and sites I use to sharpen my skills."
draft: false
---
# HELLO WORLD

## 🛡️ Daily Drivers & Learning
* [TryHackMe](https://tryhackme.com) - Gamified cybersecurity training.
* [Hack The Box](https://www.hackthebox.com) - Advanced penetration testing labs.
* [OverTheWire](https://overthewire.org/wargames/) - Great for learning Linux commands via wargames.

## 🔧 Technical Tools
* [CyberChef](https://gchq.github.io/CyberChef/) - The "Cyber Swiss Army Knife" for encoding/decoding.
* [Shodan](https://www.shodan.io) - Search engine for Internet-connected devices.
* [GTFOBins](https://gtfobins.github.io) - Curated list of Unix binaries that can be used to bypass local security.
